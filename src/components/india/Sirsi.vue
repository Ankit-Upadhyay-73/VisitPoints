    ...
    <v-app>
        <TemplateComponent>
            <v-row slot="header" style="margin-top: 2%;">
                <v-col cols="6">
                    <h2 style="font-family:Cambria;color:#eb5160">Visit Places in Sirsi</h2>
                </v-col>
                <v-spacer></v-spacer>
...
this.$http.get('https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/textsearch/json?query=attractive+places+in+Sirsi&key=AIzaSyCICaw8WPaKExjI4pOo2YeoKM4rV1CzMc4').then(function (data) {
